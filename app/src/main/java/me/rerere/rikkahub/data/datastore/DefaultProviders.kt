...
val DEFAULT_PROVIDERS = listOf(
    ProviderSetting.OpenAI(
        ...
        name = "Travel AI Gateway",
        baseUrl = DEFAULT_OPENAI_FALLBACK_BASE_URL,
        apiKey = DEFAULT_OPENAI_FALLBACK_API_KEY,
        enabled = true,
        builtIn = true,
        description = {
        ...
        models = listOf(
            Model(
                ...
                modelId = DEFAULT_OPENAI_FALLBACK_MODEL_ID,
                displayName = DEFAULT_OPENAI_FALLBACK_MODEL_NAME,
