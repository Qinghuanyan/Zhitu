...
class ConversationRepository(
    ...
    fun conversationToConversationEntity(conversation: Conversation): ConversationEntity {
        ...
        return ConversationEntity(
            ...
            travelPlan = conversation.travelPlan?.let { JsonInstant.encodeToString(it) },
            travelPlanningState = conversation.travelPlanningState.name,
    ...
    fun conversationEntityToConversation(
        ...
        return Conversation(
            ...
            travelPlan = conversationEntity.travelPlan?.let {
                runCatching { JsonInstant.decodeFromString<TravelPlan>(it) }.getOrNull()
            },
            travelPlanningState = runCatching {
                enumValueOf<TravelPlanningState>(conversationEntity.travelPlanningState)
            }.getOrDefault(TravelPlanningState.Idle),
    ...
    private fun conversationSummaryToConversation(entity: LightConversationEntity): Conversation {
        return Conversation(
            ...
            travelPlanningState = TravelPlanningState.Idle,
        )
    }
