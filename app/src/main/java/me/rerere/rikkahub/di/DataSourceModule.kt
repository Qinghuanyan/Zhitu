...
val dataSourceModule = module {
        ...
        OkHttpClient.Builder()
            ...
            .addInterceptor { chain ->
                ...
                if (originalRequest.header(HttpHeaders.UserAgent) == null) {
                    requestBuilder.addHeader(HttpHeaders.UserAgent, "AI-Assistant-Android/${BuildConfig.VERSION_NAME}")
                }
    ...
    single<AmapWebServiceApi> {
        AmapWebServiceApi.create(get())
    }

    single<QWeatherApi> {
        QWeatherApi.create(get(), BuildConfig.QWEATHER_HOST)
    }
}
